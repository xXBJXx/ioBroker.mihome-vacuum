...
for (const [implementation, modulePath] of [
    ['legacy JavaScript', '../lib/tools'],
    ['TypeScript build', '../build/lib/tools'],
]) {
    describe(`Shared tools (${implementation})`, () => {
        it('preserves the dedicated Google Translate rate-limit error', async () => {
            ...
            const tools = loadToolsWithAxios(modulePath, fakeAxios);
